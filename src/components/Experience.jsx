        ...
        <div ref={containerRef} className="relative ml-3 md:ml-0">
          ...
          <div className="absolute left-0 md:left-1/2 top-0 bottom-0 w-px bg-zinc-800 -translate-x-1/2 overflow-hidden">
            <motion.div
              ...
              className="absolute inset-0 bg-gradient-to-b from-blue-500 via-blue-400 to-blue-500/20"
            />
          </div>
            ...
            {timeline.map((item, idx) => (
              ...
              >
                ...
                <div className={`md:w-[calc(50%-2rem)] ${idx % 2 === 0 ? "md:pr-12 ml-8 md:ml-0" : "md:pl-12 ml-8 md:ml-0"}`}>
                  <div className="bg-zinc-900 border border-zinc-800 p-6 rounded-2xl hover:border-blue-500/30 transition-colors group cursor-default">
                    <span className="text-blue-500 font-mono text-sm block mb-2">{item.year}</span>
                ...
                <div className="absolute left-0 md:left-1/2 -translate-x-1/2 mt-6">
                  <motion.div
                    ...
                    className="w-4 h-4 rounded-full bg-zinc-950 border-2 border-blue-500 shadow-[0_0_10px_rgba(16,185,129,0.5)]"
                  />
                </div>
