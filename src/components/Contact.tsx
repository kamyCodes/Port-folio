    ...
    <section id="contact" className="py-24 bg-black text-white relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-3xl mx-auto text-center">
          ...
          >
            <h2 className="text-4xl md:text-6xl font-bold mb-6 tracking-tight">Let's build something <span className="text-emerald-500">together</span>.</h2>
            ...
            <div className="grid md:grid-cols-2 gap-12 mb-16 text-left">
              ...
              <div className="flex flex-col gap-4">
                ...
                <form action="https://formspree.io/f/YOUR_FORM_ID" method="POST" className="flex flex-col gap-4">
                  ...
                  <button type="submit" className="bg-emerald-500 text-black font-semibold rounded-lg px-6 py-3 mt-2 hover:bg-emerald-400 transition-colors">
                    Send Message
                  </button>
                </form>
              </div>
